...
case_intake_task = Task(
    ...
    description=(
        ...
        "- legal_domain: 1–3 words. Pick the SPECIFIC domain — do not default to 'Fraud' when a more\n"
        "  precise label applies. Suggested labels (use the best fit; not exhaustive):\n"
        "    'Cybercrime', 'Espionage', 'Fraud', 'Securities Fraud', 'Wire Fraud',\n"
        "    'Identity Theft', 'Drug Trafficking', 'Controlled Substances',\n"
        "    'Money Laundering', 'Financial Crime', 'Tax', 'Bank Robbery', 'Violent Crime',\n"
        "    'Kidnapping', 'Immigration', 'Employment', 'Environment'.\n"
        "  Examples of WRONG defaults: a kidnapping case is NOT 'Fraud'; a money-laundering case is\n"
        "  NOT 'Fraud'; a drug case is NOT 'Cybercrime'.\n"
